...
public class Driver extends Person {
    private SerializableSimpleStringProperty team,car;
    ...
    // same as the Race class, the driver class implements the serialisable functionality, got help from Telusko
